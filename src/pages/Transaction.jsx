...
const Transactions = () => {
  ...
  const handleExport = (format) => {
    ...
    if (format === 'csv') {
      ...
      // PDF export implementation using window.print()
      ...
      printWindow.document.write(`
        <html>
          <head>
            <title>Transaction Statement - Payfinity</title>
            <style>
              body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding: 20px; color: #333; }
              h1 { color: #003087; font-size: 24px; margin-bottom: 5px; }
              ...
              .logo-text { font-size: 28px; font-weight: 800; color: #003087; }
          ...
          <body>
            <table class="header-table">
              <tr>
                <td class="logo-text">Payfinity</td>
                <td class="date-info">
                  <strong>Statement Generated:</strong> ${new Date().toLocaleDateString()}<br/>
                  <strong>Total Transactions:</strong> ${exportData.length}
                </td>
              </tr>
            </table>
            <hr style="border: 0; border-top: 1px solid #eee; margin-bottom: 20px;" />
            <h1>Transaction Statement</h1>
            <p>Generated by user account for transaction history.</p>
            <table>
              <thead>
                <tr>
                  <th>ID</th>
            ...
            <div style="margin-top: 40px; text-align: center; font-size: 10px; color: #999;">
              Thank you for using Payfinity. This is an automatically generated document.
            </div>
            <script>
