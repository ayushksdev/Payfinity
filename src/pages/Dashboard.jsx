  ...
  const markAllAsRead = async () => {
    try {
      ...
      if (response.ok) {
        ...
        console.error('Failed to clear notifications on backend:', response.status);
      }
    } catch (error) {
    ...
    <div className="dashboard-container">
      ...
      <header className="dashboard-header">
        ...
        <div className="header-right">
          ...
          >
            <svg fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" style={{ width: '1.5rem', height: '1.5rem', display: 'block' }}>
      ...
      {showNotificationsPanel && (
        <div className="notifications-panel-overlay" onClick={() => setShowNotificationsPanel(false)}>
          <div className="notifications-panel" onClick={(e) => e.stopPropagation()}>
            <div className="panel-header">
              ...
              <div className="panel-actions">
                ...
                <button className="close-panel" onClick={() => setShowNotificationsPanel(false)}>
                  &times;
                </button>
              </div>
            </div>
                ...
                notifications.map((notification) => (
                  <div key={notification.id} className="notification-item unread">
                    ...
                    <div className="notification-content">
                      ...
                      <span className="notification-time">{formatDate(notification.sentAt || notification.timestamp)}</span>
                    </div>
                  </div>
                ))
              ) : (
